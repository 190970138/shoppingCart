...
public class ShoppingCart extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("				<form>");
		out.println("					<input type=\"button\" value=\"提交订单\" size=\"1\" onclick=\"javascript:window.location='OrderConfirm.do';\">");
		out.println("					<input type=\"button\" value=\"继续购物\" size=\"2\" onclick=\"javascript:window.location='ProductList.do';\">");
		out.println("					<input type=\"button\" value=\"清空购物车\" size=\"2\" onclick=\"javascript:window.location='ProductList.do';\">");
		out.println("				</form>");
		out.println("				</td>");
		out.println("			</tr>");
		out.println("		</table>");
